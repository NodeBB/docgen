...
function write(server, client) {
	require('fs').writeFileSync('output/hooks.md', '# Server Hooks' + os.EOL + os.EOL + server + os.EOL + os.EOL + '# Client Hooks' + os.EOL + os.EOL + client + os.EOL + os.EOL + '**Total Hooks: ' + hookCount + '**');
}
